          ...
          <b-navbar-nav class="ml-auto">
            <b-nav-form>
              <ul class="navbar-nav">
                <li class="nav-item">
                  <b-input-group>
                    <b-form-input size="md" class="mr-ms-0" placeholder="Search"></b-form-input>
            ...
            <ul class="navbar-nav">
              ...
              <li class="nav-item">
                <router-link to="/user/regular" class="nav-link">User</router-link>
              </li>
              <li class="nav-item">
                <router-link to="/user/org" class="nav-link">Org</router-link>
              </li>
            </ul>
          </b-navbar-nav>
        </b-collapse>
